...
# celeba original size is [120, 160, 3]
...
# summary writer
summary_writer = tf.summary.FileWriter('./summaries/simpsons_wgan', sess.graph)

''' initialization '''
ckpt_dir = './checkpoints/simpsons_wgan'
...
try:
    ...
    for it in range(sess.run(it_cnt), max_it):
        ...
        if (it + 1) % 100 == 0:
            ...
            save_dir = './sample_images_while_training/simpsons_wgan'
